      ...
      lessons: [
        {
          ...
          pdfs: [{ title: 'Goal Setting Workbook', file: 'goal_setting_workbook.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Mindfulness Guide', file: 'mindfulness_guide.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Communication Tips', file: 'communication_tips.pdf' }],
        },
        {
          title: 'Overcoming Procrastination',
          duration: '30 minutes',
          video: 'video_url_7.mp4',
          pdfs: [{ title: 'Procrastination Buster', file: 'procrastination_buster.pdf' }],
        },
        {
      ...
      lessons: [
        {
          ...
          pdfs: [{ title: 'Budgeting Guide', file: 'budgeting_guide.pdf' }],
        },
        {
          title: 'Investment Strategies',
          duration: '35 minutes',
          video: 'video_url_10.mp4',
          pdfs: [{ title: 'Investment Tips', file: 'investment_tips.pdf' }],
        },
        {
          title: 'Retirement Planning',
          duration: '40 minutes',
          video: 'video_url_11.mp4',
          pdfs: [{ title: 'Retirement Checklist', file: 'retirement_checklist.pdf' }],
        },
        {
          title: 'Tax Planning',
          duration: '28 minutes',
        ...
        },
        {
          ...
          pdfs: [{ title: 'Portfolio Management', file: 'portfolio_management.pdf' }],
        },
        {
      ...
      lessons: [
        {
          ...
          pdfs: [{ title: 'Photography Basics', file: 'photography_basics.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Portrait Photography Guide', file: 'portrait_photography_guide.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Editing Tips', file: 'editing_tips.pdf' }],
        },
        {
      ...
      lessons: [
        {
          ...
          pdfs: [{ title: 'Wedding Planning Checklist', file: 'wedding_planning_checklist.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Catering Guide', file: 'catering_guide.pdf' }],
        },
        {
        ...
        },
        {
          ...
          pdfs: [{ title: 'Budgeting Tips', file: 'wedding_budgeting_tips.pdf' }],
        },
        {
          title: 'Wedding Day Coordination',
          duration: '40 minutes',
          video: 'video_url_31.mp4',
          pdfs: [{ title: 'Day-Of Checklist', file: 'day_of_checklist.pdf' }],
        },
        {
